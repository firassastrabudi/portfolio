...
const newsletter = {
  ...
  description: (
    <>
      I occasionally write about traveling, technology, and government, and share thoughts on the intersection of creativity and engineering.
    </>
  ),
};
...
const home = {
  ...
  headline: <>Hopefully advancing drone technology and savoring culinary artistry.</>,
  featured: {
    display: true,
...
const blog = {
  path: "/blog",
  label: "Blog",
  title: "Writing about everything that i want.",
